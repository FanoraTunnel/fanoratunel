...
data_ip="https://raw.githubusercontent.com/FanoraTunnel/permission/main/ipmini"
checking_sc() {
...
Exp2=$(curl -sS https://raw.githubusercontent.com/FanoraTunnel/permission/main/ipmini | grep $ipsaya | awk '{print $3}')
d1=$(date -d "$Exp2" +%s)
d2=$(date -d "$today" +%s)
